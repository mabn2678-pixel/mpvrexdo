...
interface VideoRepository {
    ...
    suspend fun restoreVideoFromSecureFolder(videoId: String, context: android.content.Context): Result<Unit>
    suspend fun restoreVideosFromSecureFolder(videos: List<VideoItem>, context: android.content.Context): Result<Unit>
    suspend fun deleteSecureVideos(videos: List<VideoItem>, context: android.content.Context): Result<Unit>
