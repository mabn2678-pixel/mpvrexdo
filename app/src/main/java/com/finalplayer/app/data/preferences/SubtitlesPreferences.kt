...
class SubtitlesPreferences(private val dataStore: DataStore<Preferences>) {
    companion object {
        ...
        val FONT_SIZE_PORTRAIT = intPreferencesKey("sub_font_size_portrait")
        val FONT_SIZE_PIP = intPreferencesKey("sub_font_size_pip")
    ...
    val fontSize             = pref(FONT_SIZE, 41)
    val fontSizePortrait     = pref(FONT_SIZE_PORTRAIT, 21)
    val fontSizePip          = pref(FONT_SIZE_PIP, 61)
